...
import { buttonClick, sildeIn, staggerFadeInOut } from '../animation'
...
const Cart = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-start justify-start rounded-t-3xl bg-zinc900 h-full py-6  gap-3 relative">
        {cart && cart?.length > 0 ? (<>
            ...
            <div className="bg-zinc800 rounded-t-[60px] w-full h-[35%] flex flex-col items-center px-4 py-6  gap-8 ">
              <div className="w-full flex items-center justify-evenly ">
                <p className="text-3xl text-zinc500 font-semibold">Total</p>
                <p className="text-3xl text-green5 font-semibold flex items-center justify-center gap-1">
              ...
              <motion.button
                {...buttonClick}
                className="bg-green4  flex items-center justify-center w-[70%]  px-4 py-3 text-xl text-headingColor font-semibold hover:bg-orange500 drop-shadow-md rounded-2xl "
...
export const CartItemCard = ({ index, data }) => {
    ...
    return (
        ...
        className="w-full flex items-center justify-start bg-zinc800 rounded-md drop-shadow-md px-4 gap-4"        
        >
            <img
                src={data?.imageURL}
            ...
            <div className="flex items-center justify-start gap-1 w-full">
                    <p className="text-lg text-primary font-semibold">
                        {data?.product_name}
                        <span className="text-sm block capitalize text-gray4">
                            {data?.product_category}
                        </span>
                    </p>
                    <p className="text-sm flex items-center justify-center gap-1 font-semibold text-green4 ml-auto">
                        <HiCurrencyRupee className="text-green4" /> {itemTotal}
                    </p>
            </div>
            ...
            <div className="ml-auto flex items-center justify-center gap-3">
                <motion.div
                    ...
                    className="w-8 h-8 flex items-center justify-center rounded-md drop-shadow-md bg-zinc900 cursor-pointer"
                >
